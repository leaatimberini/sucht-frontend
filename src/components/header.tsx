...
          </Link>
          ...
          {/* ===== ENLACE A LA TIENDA Y CARRITO (VISIBLE PARA USUARIOS LOGUEADOS) ===== */}
          {hasMounted && user && (
...
        __
<a href="/logout" onClick={handleLogout} className="w-full text-left flex items-center gap-3 px-4 py-3 hover:bg-red-600/80 transition-colors border-t border-zinc-700">
<LogOut size={16} />
Cerrar sesión
</a>
</div>
