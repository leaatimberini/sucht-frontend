...
// CORRECCIÓN: Añadimos 'quantity' al esquema de validación
...
    // CORRECCIÓN: Establecemos un valor por defecto para 'quantity'
    defaultValues: {
      quantity: 1,
    },
  });
...
        quantity: data.quantity // CORRECCIÓN: Enviamos la cantidad
      });
...
        {/* CORRECCIÓN: Añadimos el campo de cantidad */}
        <div>
          <label htmlFor={`quantity-${event.id}`} className="block text-sm font-medium text-zinc-300 mb-1">Cantidad</label>
          <input
            {...register('quantity')}
