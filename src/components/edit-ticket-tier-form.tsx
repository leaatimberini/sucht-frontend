...
  });
  ...
  useEffect(() => {
    // CORRECCIÓN: Reseteamos el formulario con los valores actuales del tier
    reset({
      name: tier.name,
      isFree: tier.isFree,
      price: tier.price,
...
  // Observamos el valor del checkbox de pago parcial y el de entrada gratis
...
      const payload = {
        ...data,
        // CORRECCIÓN: Aseguramos que el precio sea 0 si la entrada es gratis
...
      </div>
      ...
      {/* CORRECCIÓN: Añadimos el checkbox para la entrada gratis */}
...
      )}
      ...
      {/* CORRECCIÓN: Ocultamos el campo de precio si es una entrada gratis */}
      {!isFreeTicket && (
        <div>
