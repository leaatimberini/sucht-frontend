...
// Importamos todos los componentes de las pestañas
...
import { UsernamePrompt } from "./components/UsernamePrompt"; // Se importa el nuevo componente

// Tipos centralizados para esta página
export type UserProfile = User & { isPushSubscribed?: boolean; points?: number };
export interface Reward { id: string; name: string; description: string | null; pointsCost: number; stock: number | null; isActive: boolean; }
export interface UserReward { id: string; reward: Reward; redeemedAt: string | null; createdAt: string; }
...
        
        {/* Se añade el componente para el link de referido */}
        <UsernamePrompt />
