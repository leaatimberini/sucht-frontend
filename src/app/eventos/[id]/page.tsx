...
// NUEVA FUNCIÓN: Obtiene los tipos de entrada y su cantidad
...
  const event = await getEvent(params.id);
  const tiers = await getEventTiers(params.id); // Llamamos a la nueva función
...
            <p className="text-zinc-300 mt-4 whitespace-pre-wrap">{event.description}</p>
            ...
            {/* NUEVA SECCIÓN: Muestra la disponibilidad de las entradas */}
