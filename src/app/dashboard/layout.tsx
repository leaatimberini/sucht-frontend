...
  CreditCard,
  Gift,
  ShoppingBasket // <-- 1. Ícono añadido
} from "lucide-react";
...
            <ul className="space-y-2">
              {/* ... (tus enlaces existentes se mantienen igual) ... */}
              <li>
...
                </Link>
              </li>
                  {/* --- 2. NUEVO ENLACE A LA PÁGINA DE PRODUCTOS --- */}
                  <li>
                    <Link href="/dashboard/products" className="flex items-center space-x-2 text-zinc-300 hover:bg-zinc-700 px-3 py-2 rounded-md transition-colors">
