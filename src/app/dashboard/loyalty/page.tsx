...
  const [isLoading, setIsLoading] = useState(false);
  ...
  // 2. Función para buscar los datos con los filtros
  const fetchData = async () => {
    if (!startDate || !endDate) {
      // Opcional: podrías mostrar un toast pidiendo que se seleccionen las fechas
      return;
    }
    try {
      setIsLoading(true);
...
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
          {/* --- SECCIÓN DE ASISTENCIA PERFECTA --- */}
          <div>
