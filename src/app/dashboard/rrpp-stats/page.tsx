...
    setIsLoading(true);
    setError(null); // ✅ Resetea el error en cada llamada
    try {
...
      
      // ✅ CORRECCIÓN: Verifica que los datos sean un array antes de establecer el estado
...
      setError("Error al cargar los datos de rendimiento de RRPP."); // ✅ Establece un mensaje de error
      setPerformance([]); // ✅ Asegura que el estado sea un array vacío para evitar errores
    } finally {
      setIsLoading(false);
    }
...
              ))
            ) : (
              <tr><td colSpan={4} className="text-center p-6 text-zinc-400">No hay datos de rendimiento de RRPP para mostrar.</td></tr>
            )}
          </tbody>
        </table>
      </div>
