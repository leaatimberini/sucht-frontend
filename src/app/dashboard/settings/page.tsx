...
import { z } from 'zod';
import { Loader2, Save, Users, DollarSign, Percent, Settings, Star, CreditCard, CheckCircle, XCircle } from 'lucide-react';
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                ...
                {user?.isMpLinked ? (
                    <div className="flex items-center gap-4">
                        <span className="flex items-center gap-2 text-green-400"><CheckCircle size={16}/> Cuenta Vinculada</span>
                        <button type="button" onClick={handleUnlinkMP} className="text-red-500 hover:underline text-sm">Desvincular</button>
                    </div>
                ) : (
